...
class SubnetCalculator:
    ...
    def validate_network_ip(self):
        ...
        if not self.validate_ipv4(self.network_ip.split('/')[0]):
            raise InvalidIPError()
    ...
    def get_network_info(self):
        ...
        result.append(f"Number of Usable Hosts: {2**(32-self.network.prefixlen) - 2}")
...
class SubnetCalculatorApp:
    def __init__(self, root):
        ...
        self.network_ip_label = tk.Label(root, text="Network IP Address (e.g., 192.168.1.0/24):")
